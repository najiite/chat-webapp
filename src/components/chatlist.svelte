...
<li>
    <a href={`/chat/${chat.chatkey}/${receiver}`} class="flex items-center p-2 text-base font-normal  text-teal-900 hover:text-teal-50 rounded-lg dark:text-white hover:bg-teal-900">
        ...
        <span class="flex-1 text-xs ml-3 whitespace-nowrap">{recipient}</span>
        <button class="inline-flex justify-center items-center px-2 ml-3 text-sm font-medium">
